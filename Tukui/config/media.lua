TukuiCF["media"] = {
	...
	["fr_uffont"] = [[Interface\AddOns\Tukui\media\fonts\normal_font.ttf]], -- general font of unitframes
	...
	["altbordercolor"] = { .15,.15,.15,1 }, -- alternative border color, mainly for unitframes text panels.
