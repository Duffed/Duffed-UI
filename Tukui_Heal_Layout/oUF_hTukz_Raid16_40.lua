...
local function Shared(self, unit)
	...
	health.value:SetPoint("BOTTOM", health, TukuiDB.Scale(1), 1)
	...
	TukuiDB.CreatePanel(panel,1,1,"TOPLEFT", health, "TOPLEFT", TukuiDB.Scale(-2), TukuiDB.Scale(2))
	panel:SetPoint("BOTTOMRIGHT", power, "BOTTOMRIGHT", TukuiDB.Scale(2), TukuiDB.Scale(-2))
	...
	if TukuiCF["unitframes"].healcomm then
		...
		if TukuiCF["unitframes"].gridhealthvertical then
			...
			mhpb:SetWidth(TukuiDB.Scale(68*TukuiCF["unitframes"].gridscale*TukuiDB.raidscale))
			mhpb:SetHeight(TukuiDB.Scale(31*TukuiCF["unitframes"].gridscale*TukuiDB.raidscale))		
		else
		...
		if TukuiCF["unitframes"].gridhealthvertical then
			...
			ohpb:SetWidth(TukuiDB.Scale(68*TukuiCF["unitframes"].gridscale*TukuiDB.raidscale))
			ohpb:SetHeight(TukuiDB.Scale(31*TukuiCF["unitframes"].gridscale*TukuiDB.raidscale))
		else
...
oUF:Factory(function(self)
	...
	if TukuiCF["unitframes"].gridonly ~= true then
		...
		local raid = self:SpawnHeader("oUF_TukuiHealRaid2540", nil, "raid,party",
			...
			"maxColumns", 8,
			"unitsPerColumn", 5,
			"columnSpacing", TukuiDB.Scale(8),
			"columnAnchorPoint", "BOTTOM"		
		)
		if ChatBG1 then
			raid:SetPoint("BOTTOMLEFT", ChatBG1, "TOPLEFT", 2, 72)
		else
